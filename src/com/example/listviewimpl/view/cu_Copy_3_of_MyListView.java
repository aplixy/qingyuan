...
public class cu_Copy_3_of_MyListView extends AdapterView<Adapter> {
	...
	public cu_Copy_3_of_MyListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public cu_Copy_3_of_MyListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public cu_Copy_3_of_MyListView(Context context) {
		super(context);
		init();
	}
	...
	private void layoutPositionItemsDown(int parentLeft) {
		int bottom = (int) (getChildAt(getChildCount() - 1).getBottom() + mScrolledDistance);
